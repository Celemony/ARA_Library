...
ProxyPlugIn::DispatchTarget ProxyPlugIn::getDispatchTargetForIncomingTransaction (MessageID messageID)
{
    ...
    ARA_INTERNAL_ASSERT ((messageID < ARA_IPC_HOST_METHOD_ID (ARAArchivingControllerInterface, getArchiveSize).getMessageID ()) ||
                         (ARA_IPC_HOST_METHOD_ID (ARAArchivingControllerInterface, getDocumentArchiveID).getMessageID () < messageID));
    ...
    ARA_INTERNAL_ASSERT ((messageID < ARA_IPC_HOST_METHOD_ID (ARAModelUpdateControllerInterface, notifyAudioSourceAnalysisProgress).getMessageID ()) ||
                         (ARA_IPC_HOST_METHOD_ID (ARAModelUpdateControllerInterface, notifyDocumentDataChanged).getMessageID () < messageID));
